...
# 2. 최적화 실행
study.optimize(
    lambda trial: objective(trial, model_choose="ft_transformer", region="busan", data_sample='smotenc_ctgan20000'), 
    n_trials=100
,
...
try:
    ...
    study_path = os.path.join(base_dir, "optimization_history/ft_transformer_smotenc_ctgan20000_busan_trials.pkl")
