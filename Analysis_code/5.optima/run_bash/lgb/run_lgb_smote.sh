...
START_TIME=$(date +%s)
echo "=========================================="
echo "LGB SMOTE 파일 실행 시작"
echo "시작 시간: $(date '+%Y-%m-%d %H:%M:%S')"
echo "GPU: 1번 (os.environ['CUDA_VISIBLE_DEVICES'] = '1')"
echo "=========================================="
echo ""
...
FILES=(
    "LGB_smote_busan.py"
    "LGB_smote_daegu.py"
    "LGB_smote_daejeon.py"
    "LGB_smote_gwangju.py"
    "LGB_smote_incheon.py"
    "LGB_smote_seoul.py"
)
...
for file in "${FILES[@]}"; do
    ...
    # Python 스크립트 실행 (os.environ으로 GPU 1번 설정)
