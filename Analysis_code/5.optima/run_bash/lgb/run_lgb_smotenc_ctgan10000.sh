...
START_TIME=$(date +%s)
echo "=========================================="
echo "LGB SMOTENC CTGAN10000 파일 실행 시작"
...
# 실행할 파일 목록
FILES=(
    "LGB_smotenc_ctgan10000_busan.py"
    "LGB_smotenc_ctgan10000_daegu.py"
    "LGB_smotenc_ctgan10000_daejeon.py"
    "LGB_smotenc_ctgan10000_gwangju.py"
    "LGB_smotenc_ctgan10000_incheon.py"
    "LGB_smotenc_ctgan10000_seoul.py"
)
...
for file in "${FILES[@]}"; do
    filepath="lgb_smotenc_ctgan10000/$file"
    if [ ! -f "$filepath" ]; then
...
echo "=========================================="
echo "LGB SMOTENC CTGAN10000 파일 실행 완료"
