...
START_TIME=$(date +%s)
echo "=========================================="
echo "XGB SMOTE 파일 실행 시작"
echo "시작 시간: $(date '+%Y-%m-%d %H:%M:%S')"
echo "GPU: 0번 (os.environ['CUDA_VISIBLE_DEVICES'] = '0')"
echo "=========================================="
echo ""
...
FILES=(
    "XGB_smote_busan.py"
    "XGB_smote_daegu.py"
    "XGB_smote_daejeon.py"
    "XGB_smote_gwangju.py"
    "XGB_smote_incheon.py"
    "XGB_smote_seoul.py"
)
...
for file in "${FILES[@]}"; do
    ...
    # Python 스크립트 실행 (os.environ으로 GPU 0번 설정)
