...
START_TIME=$(date +%s)
echo "=========================================="
echo "ResNet-Like SMOTENC CTGAN10000 파일 실행 시작"
...
# 실행할 파일 목록
FILES=(
    "resnet_like_smotenc_ctgan10000_busan.py"
    "resnet_like_smotenc_ctgan10000_daegu.py"
    "resnet_like_smotenc_ctgan10000_daejeon.py"
    "resnet_like_smotenc_ctgan10000_gwangju.py"
    "resnet_like_smotenc_ctgan10000_incheon.py"
    "resnet_like_smotenc_ctgan10000_seoul.py"
)
...
for file in "${FILES[@]}"; do
    filepath="resnet_like_smotenc_ctgan10000/$file"
    if [ ! -f "$filepath" ]; then
...
echo "=========================================="
echo "ResNet-Like SMOTENC CTGAN10000 파일 실행 완료"
