...
# 실행할 파일 목록
FILES=(
    "deepgbm_smote_busan.py"
    "deepgbm_smote_daegu.py"
    "deepgbm_smote_daejeon.py"
    "deepgbm_smote_gwangju.py"
    "deepgbm_smote_incheon.py"
    "deepgbm_smote_seoul.py"
)
