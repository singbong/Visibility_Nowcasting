...
START_TIME=$(date +%s)
echo "=========================================="
echo "DeepGBM SMOTENC CTGAN10000 파일 실행 시작"
...
# 실행할 파일 목록
FILES=(
    "deepgbm_smotenc_ctgan10000_busan.py"
    "deepgbm_smotenc_ctgan10000_daegu.py"
    "deepgbm_smotenc_ctgan10000_daejeon.py"
    "deepgbm_smotenc_ctgan10000_gwangju.py"
    "deepgbm_smotenc_ctgan10000_incheon.py"
    "deepgbm_smotenc_ctgan10000_seoul.py"
)
...
for file in "${FILES[@]}"; do
    filepath="deepgbm_smotenc_ctgan10000/$file"
    if [ ! -f "$filepath" ]; then
...
echo "=========================================="
echo "DeepGBM SMOTENC CTGAN10000 파일 실행 완료"
