...
# 실행할 파일 목록
FILES=(
    "deepgbm_pure_busan.py"
    "deepgbm_pure_daegu.py"
    "deepgbm_pure_daejeon.py"
    "deepgbm_pure_gwangju.py"
    "deepgbm_pure_incheon.py"
    "deepgbm_pure_seoul.py"
)
