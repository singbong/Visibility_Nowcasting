...
START_TIME=$(date +%s)
echo "=========================================="
echo "FT-Transformer SMOTENC CTGAN10000 파일 실행 시작"
...
# 실행할 파일 목록
FILES=(
    "ft_transformer_smotenc_ctgan10000_busan.py"
    "ft_transformer_smotenc_ctgan10000_daegu.py"
    "ft_transformer_smotenc_ctgan10000_daejeon.py"
    "ft_transformer_smotenc_ctgan10000_gwangju.py"
    "ft_transformer_smotenc_ctgan10000_incheon.py"
    "ft_transformer_smotenc_ctgan10000_seoul.py"
)
...
for file in "${FILES[@]}"; do
    filepath="ft_transformer_smotenc_ctgan10000/$file"
    if [ ! -f "$filepath" ]; then
...
echo "=========================================="
echo "FT-Transformer SMOTENC CTGAN10000 파일 실행 완료"
