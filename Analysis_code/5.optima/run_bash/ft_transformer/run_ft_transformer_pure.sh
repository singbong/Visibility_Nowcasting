...
START_TIME=$(date +%s)
echo "=========================================="
echo "FT-Transformer Pure 파일 실행 시작"
...
# 실행할 파일 목록
FILES=(
    "ft_transforemer_pure_busan.py"
    "ft_transforemer_pure_daegu.py"
    "ft_transforemer_pure_daejeon.py"
    "ft_transforemer_pure_gwangju.py"
    "ft_transforemer_pure_incheon.py"
    "ft_transforemer_pure_seoul.py"
)
...
for file in "${FILES[@]}"; do
    filepath="ft_transformer_pure/$file"
    if [ ! -f "$filepath" ]; then
...
echo "=========================================="
echo "FT-Transformer Pure 파일 실행 완료"
