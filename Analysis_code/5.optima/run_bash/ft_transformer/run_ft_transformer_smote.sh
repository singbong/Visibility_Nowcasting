...
START_TIME=$(date +%s)
echo "=========================================="
echo "FT-Transformer SMOTE 파일 실행 시작"
...
# 실행할 파일 목록
FILES=(
    "ft_transformer_smote_busan.py"
    "ft_transformer_smote_daegu.py"
    "ft_transformer_smote_daejeon.py"
    "ft_transformer_smote_gwangju.py"
    "ft_transformer_smote_incheon.py"
    "ft_transformer_smote_seoul.py"
)
...
for file in "${FILES[@]}"; do
    filepath="ft_transformer_smote/$file"
    if [ ! -f "$filepath" ]; then
...
echo "=========================================="
echo "FT-Transformer SMOTE 파일 실행 완료"
