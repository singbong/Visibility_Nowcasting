...
def objective_func(search_space):
    ...
    # 각 fold에 대해 교차 검증 수행
    for df_sampled, (train_years, val_year) in zip(df_smote_list, FOLD_CONFIGS):
...
trials_path = os.path.join(base_dir, "optimization_history/xgb_smote_busan_trials.pkl")
...
# 모델 저장
print("모델 저장 중...")
model_save_path = os.path.join(base_dir, "save_model/xgb_optima/xgb_smote_busan.pkl")
