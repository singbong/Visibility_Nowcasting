...
def split_data(df_original, train_years, val_year):
...
def objective_func(search_space):
    ...
    for train_years, val_year in FOLD_CONFIGS:
        X_train, X_val, y_train, y_val = split_data(
            df_incheon, train_years, val_year
        )
...
trials_path = os.path.join(base_dir, "optimization_history/xgb_pure_incheon_trials.pkl")
...
# 모델 저장
print("모델 저장 중...")
model_save_path = os.path.join(base_dir, "save_model/xgb_optima/xgb_pure_incheon.pkl")
