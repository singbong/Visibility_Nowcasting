...
trials_path = os.path.join(base_dir, "optimization_history/xgb_pure_gwangju_trials.pkl")
...
# 모델 저장
print("모델 저장 중...")
model_save_path = os.path.join(base_dir, "save_model/xgb_optima/xgb_pure_gwangju.pkl")
