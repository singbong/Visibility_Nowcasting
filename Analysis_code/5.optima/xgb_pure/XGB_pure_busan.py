...
def split_data_pure(df_original, train_years, val_year):
    ...
    """
    X_train = df_original.loc[df_original['year'].isin(train_years), df_original.columns != 'multi_class'].copy()
    X_val = df_original.loc[df_original['year'] == val_year, df_original.columns != 'multi_class'].copy()
    y_train = df_original.loc[df_original['year'].isin(train_years), 'multi_class']
    y_val = df_original.loc[df_original['year'] == val_year, 'multi_class']
...
trials_path = os.path.join(base_dir, "optimization_history/xgb_pure_busan_trials.pkl")
...
# 모델 저장
print("모델 저장 중...")
model_save_path = os.path.join(base_dir, "save_model/xgb_optima/xgb_pure_busan.pkl")
