...
def objective_func(search_space):
    ...
    for df_sampled, (train_years, val_year) in zip(df_smotenc_ctgan_list, FOLD_CONFIGS):
        X_train, X_val, y_train, y_val = split_data(
            df_sampled, df_gwangju, train_years, val_year
        )
...
trials_path = os.path.join(base_dir, "optimization_history/xgb_smotenc_ctgan20000_gwangju_trials.pkl")
...
# 모델 저장
print("모델 저장 중...")
model_save_path = os.path.join(base_dir, "save_model/xgb_optima/xgb_smotenc_ctgan20000_gwangju.pkl")
