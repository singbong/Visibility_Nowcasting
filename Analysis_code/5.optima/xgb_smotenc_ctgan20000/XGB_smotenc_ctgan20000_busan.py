...
def objective_func(search_space):
    ...
    # 각 fold에 대해 교차 검증 수행
    for df_sampled, (train_years, val_year) in zip(df_smotenc_ctgan_list, FOLD_CONFIGS):
        X_train, X_val, y_train, y_val = split_data(
            df_sampled, df_busan, train_years, val_year
        )
...
trials_path = os.path.join(base_dir, "optimization_history/xgb_smotenc_ctgan20000_busan_trials.pkl")
...
model_save_path = os.path.join(base_dir, "save_model/xgb_optima/xgb_smotenc_ctgan20000_busan.pkl")
