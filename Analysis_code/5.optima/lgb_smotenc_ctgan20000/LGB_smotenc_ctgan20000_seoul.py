...
df_smotenc_ctgan_seoul_1 = pd.read_csv(os.path.join(data_base_dir, "data_oversampled/smotenc_ctgan20000/smotenc_ctgan20000_1_seoul.csv"))
df_smotenc_ctgan_seoul_2 = pd.read_csv(os.path.join(data_base_dir, "data_oversampled/smotenc_ctgan20000/smotenc_ctgan20000_2_seoul.csv"))
df_smotenc_ctgan_seoul_3 = pd.read_csv(os.path.join(data_base_dir, "data_oversampled/smotenc_ctgan20000/smotenc_ctgan20000_3_seoul.csv"))
...
model_save_path = os.path.join(base_dir, "save_model/lgb_optima/lgb_smotenc_ctgan20000_seoul.pkl")
