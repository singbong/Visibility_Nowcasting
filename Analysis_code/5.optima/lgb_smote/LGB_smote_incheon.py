...
df_smote_incheon_1 = pd.read_csv(os.path.join(data_base_dir, "data_oversampled/smote/smote_1_incheon.csv"))
df_smote_incheon_2 = pd.read_csv(os.path.join(data_base_dir, "data_oversampled/smote/smote_2_incheon.csv"))
df_smote_incheon_3 = pd.read_csv(os.path.join(data_base_dir, "data_oversampled/smote/smote_3_incheon.csv"))
...
df_smote_list = [df_smote_incheon_1, df_smote_incheon_2, df_smote_incheon_3]
...
def objective_func(search_space):
    ...
    for df_smote, (train_years, val_year) in zip(df_smote_list, FOLD_CONFIGS):
        X_train, X_val, y_train, y_val = split_data(
            df_smote, df_incheon, train_years, val_year
        )
