...
df_smotenc_ctgan_daegu_1 = pd.read_csv(os.path.join(data_base_dir, "data_oversampled/smotenc_ctgan10000/smotenc_ctgan10000_1_daegu.csv"))
df_smotenc_ctgan_daegu_2 = pd.read_csv(os.path.join(data_base_dir, "data_oversampled/smotenc_ctgan10000/smotenc_ctgan10000_2_daegu.csv"))
df_smotenc_ctgan_daegu_3 = pd.read_csv(os.path.join(data_base_dir, "data_oversampled/smotenc_ctgan10000/smotenc_ctgan10000_3_daegu.csv"))

# 데이터 전처리
print("데이터 전처리 중...")
df_smotenc_ctgan_daegu_1 = preprocessing(df_smotenc_ctgan_daegu_1)
df_smotenc_ctgan_daegu_2 = preprocessing(df_smotenc_ctgan_daegu_2)
df_smotenc_ctgan_daegu_3 = preprocessing(df_smotenc_ctgan_daegu_3)
df_daegu = preprocessing(df_daegu)

# SMOTENC+CTGAN 데이터 리스트 (fold 순서와 일치)
df_smotenc_ctgan_list = [df_smotenc_ctgan_daegu_1, df_smotenc_ctgan_daegu_2, df_smotenc_ctgan_daegu_3]
...
def objective_func(search_space):
    ...
    for df_smotenc_ctgan, (train_years, val_year) in zip(df_smotenc_ctgan_list, FOLD_CONFIGS):
        X_train, X_val, y_train, y_val = split_data(
            df_smotenc_ctgan, df_daegu, train_years, val_year
        )
...
trials_path = os.path.join(base_dir, "optimization_history/lgb_smotenc_ctgan10000_daegu_trials.pkl")
...
model_save_path = os.path.join(base_dir, "save_model/lgb_optima/lgb_smotenc_ctgan10000_daegu.pkl")
