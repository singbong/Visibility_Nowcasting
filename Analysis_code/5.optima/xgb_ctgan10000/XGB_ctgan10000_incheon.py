...
trials_path = os.path.join(base_dir, "optimization_history/xgb_ctgan10000_incheon_trials.pkl")
...
model_save_path = os.path.join(base_dir, "save_model/xgb_optima/xgb_ctgan10000_incheon.pkl")
