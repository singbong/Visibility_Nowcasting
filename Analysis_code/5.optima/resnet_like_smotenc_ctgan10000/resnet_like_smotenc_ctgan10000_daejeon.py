...
# 2. 최적화 실행
study.optimize(
    lambda trial: objective(trial, model_choose="resnet_like", region="daejeon", data_sample='smotenc_ctgan10000'), 
    n_trials=100
,
...
try:
    ...
    study_path = os.path.join(base_dir, "optimization_history/resnet_like_smotenc_ctgan10000_daejeon_trials.pkl")
