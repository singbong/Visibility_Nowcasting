...
# 2. 최적화 실행
study.optimize(
    lambda trial: objective(trial, model_choose="resnet_like", region="busan", data_sample='smote'), 
    n_trials=100
,
...
try:
    ...
    study_path = os.path.join(base_dir, "optimization_history/resnet_like_smote_busan_trials.pkl")
